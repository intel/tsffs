...
/// (`srai zero, zero, n`) with a specific value of `n`, after setting register
/// `a0` to the value of the pointer to the testcase and register `a1` to the
/// value of the pointer to the testcase size. These registers are accessed by
/// the fuzzer and are defined per-architecture.
...
/// Invoke the magic instruction defined by SIMICS for the RISC-V architecture
/// (`srai zero, zero, n`) with a specific value of `n`
#define __srai(value) \
