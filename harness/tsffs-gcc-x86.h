...
/// Invoke the magic instruction defined by SIMICS for the x86 architecture
/// (`cpuid`) with a specific value of `n`, after setting register `edi` to the
/// value of the pointer to the testcase and register `esi` to the value of the
