...
fn test_harnessing_x509_parse_cli() -> Result<()> {
    ...
    let args = &[
        ...
        "--file",
        &format!("{}/examples/x509-parse/rsrc/X509Parse.efi:%simics%/targets/x509-parse/X509Parse.efi", CARGO_MANIFEST_DIR),
        "--file",
        &format!("{}/examples/x509-parse/rsrc/app.py:%simics%/scripts/app.py", CARGO_MANIFEST_DIR),
        "--file",
        &format!("{}/examples/x509-parse/rsrc/app.yml:%simics%/scripts/app.yml", CARGO_MANIFEST_DIR),
        "--file",
        &format!("{}/examples/x509-parse/rsrc/minimal_boot_disk.craff:%simics%/targets/x509-parse/minimal_boot_disk.craff", CARGO_MANIFEST_DIR),
        "--file",
        &format!("{}/examples/x509-parse/rsrc/run_uefi_app.nsh:%simics%/targets/x509-parse/run_uefi_app.nsh", CARGO_MANIFEST_DIR),
        "--file",
        &format!("{}/examples/x509-parse/rsrc/run-uefi-app.simics:%simics%/targets/x509-parse/run-uefi-app.simics", CARGO_MANIFEST_DIR),
        "--command",
