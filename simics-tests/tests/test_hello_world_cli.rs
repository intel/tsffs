...
fn test_hello_world_cli() -> Result<()> {
    ...
    let args = &[
        ...
        "--file",
        &format!("{}/examples/hello-world/rsrc/HelloWorld.efi:%simics%/targets/hello-world/HelloWorld.efi", CARGO_MANIFEST_DIR),
        "--file",
        &format!("{}/examples/hello-world/rsrc/app.py:%simics%/scripts/app.py", CARGO_MANIFEST_DIR),
        "--file",
        &format!("{}/examples/hello-world/rsrc/app.yml:%simics%/scripts/app.yml", CARGO_MANIFEST_DIR),
        "--file",
        &format!("{}/examples/hello-world/rsrc/minimal_boot_disk.craff:%simics%/targets/hello-world/minimal_boot_disk.craff", CARGO_MANIFEST_DIR),
        "--file",
        &format!("{}/examples/hello-world/rsrc/run_uefi_app.nsh:%simics%/targets/hello-world/run_uefi_app.nsh", CARGO_MANIFEST_DIR),
        "--file",
        &format!("{}/examples/hello-world/rsrc/run-uefi-app.simics:%simics%/targets/hello-world/run-uefi-app.simics", CARGO_MANIFEST_DIR),
        "--command",
