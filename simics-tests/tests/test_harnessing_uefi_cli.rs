...
fn test_harnessing_uefi_cli() -> Result<()> {
    ...
    let args = &[
        ...
        "--file",
        &format!("{}/examples/harnessing-uefi/rsrc/target.efi:%simics%/target.efi", CARGO_MANIFEST_DIR),
        "--file",
        &format!("{}/examples/harnessing-uefi/rsrc/minimal_boot_disk.craff:%simics%/minimal_boot_disk.craff", CARGO_MANIFEST_DIR),
        "--file",
        &format!("{}/examples/harnessing-uefi/rsrc/fuzz.simics:%simics%/fuzz.simics", CARGO_MANIFEST_DIR),
        "--command",
