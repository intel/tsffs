...
SIM_INTERFACE(tsffs) {
    ...
    void (*start)(conf_object_t * obj, conf_object_t * _cpu, generic_address_t testcase_address, generic_address_t size_address, bool virt);
    void (*start_with_maximum_size)(conf_object_t * obj, conf_object_t * _cpu, generic_address_t testcase_address, uint32 maximum_size, bool virt);
