...
SIM_INTERFACE(tsffs) {
  ...
  void (*start)(conf_object_t* obj, conf_object_t* cpu,
                generic_address_t testcase_address,
                generic_address_t size_address, bool virt);
  void (*start_with_maximum_size)(conf_object_t* obj, conf_object_t* cpu,
                                  generic_address_t testcase_address,
                                  uint32 maximum_size, bool virt);
  ...
  void (*set_all_exceptions_are_solutions)(conf_object_t* obj,
                                           bool all_exceptions_are_solutions);
  void (*add_breakpoint_solution)(conf_object_t* obj,
                                  breakpoint_id_t breakpoint);
  void (*remove_breakpoint_solution)(conf_object_t* obj,
                                     breakpoint_id_t breakpoint);
  void (*set_all_breakpoints_are_solutions)(conf_object_t* obj,
                                            bool all_breakpoints_are_solutions);
  void (*set_cmplog_enabled)(conf_object_t* obj, bool enabled);
  void (*set_corpus_directory)(conf_object_t* obj, char* corpus_directory);
  void (*set_solutions_directory)(conf_object_t* obj,
                                  char* solutions_directory);
  void (*set_generate_random_corpus)(conf_object_t* obj,
                                     bool generate_random_corpus);
  ...
  void (*add_architecture_hint)(conf_object_t* obj, conf_object_t* cpu,
                                char* hint);
