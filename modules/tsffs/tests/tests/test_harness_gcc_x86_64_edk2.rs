...
const TEST_UEFI: &[u8] = include_bytes!("../targets/minimal-x86_64-edk2/test.efi");

#[test]
fn test_harness_gcc_x86_64_edk2() -> Result<()> {
    let script = indoc! {r#"
    ...
    assert!(
        output_str.contains("4444 4444 4444 4444 4444 4444 4444 444"),
        "Output does not contain initial buffer"
    );
    assert!(
        output_str.contains("4000 0000 0000 0000"),
